...
function converterPrecoParaReais1(precoEmDolar1, taxaDeCambio1, iof1, lucro1) {
    ...
    var precoVenda1 = precoComIOF1 * (1 + lucro1 / 100); //precoVenda já pega o valor completo, portanto é o último a ser escrito
...
produtos1.forEach(function (produto1) {
    ...
    console.log("Pre\u00E7o de venda (com 49% de lucro): R$ ".concat(precoVenda1.toFixed(2), "\n")); //Mostrado por ultimo para uma conclusão
});
