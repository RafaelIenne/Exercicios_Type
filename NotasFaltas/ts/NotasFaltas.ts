...
const nomeAluno1: string = "Arlindo";
const notaMatematica1: number = 6;
const notaPortugues1: number = 8;
const notaCiencias1: number = 7;
const faltasMatematica1: number = 1; // Faltas em Matemática
const faltasPortugues1: number = 6;  // Faltas em Português
const faltasCiencias1: number = 5;   // Faltas em Ciências
